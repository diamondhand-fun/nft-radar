...
const usage = "Usage: npm run --silent inspect -- [--confirmations N] [--timeout MS] [--block-tag latest|safe|finalized] [--from-block N] [--to-block N] [--json-errors] <token-or-tx-hash> [selected-token]";
